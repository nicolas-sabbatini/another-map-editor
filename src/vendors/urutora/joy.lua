...
function joy:draw()
  ...
  if self.layer3 then
    ...
    local lsBkp = love.graphics.getLineStyle()
    love.graphics.setLineStyle('smooth')
    love.graphics.circle('line', self:centerX() + self.joyX, self:centerY() + self.joyY, self:stickRadius())
    love.graphics.setLineStyle(lsBkp)
  end
  if not self.enabled then
